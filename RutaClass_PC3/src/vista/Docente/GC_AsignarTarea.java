 ...
 */
public class GC_AsignarTarea extends javax.swing.JFrame {

    private UsuarioType usuarioType;

    public GC_AsignarTarea() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel14.setText("Asignar Tarea");
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "PDF", "ppt", "png", "txt" }));

        jLabel16.setFont(new java.awt.Font("Yu Gothic Medium", 0, 18)); // NOI18N
        jLabel16.setText("Tipo de archivo:");
    ...
    private void btn_CalificarEstActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_CalificarEstActionPerformed
        askToProceed();
        GC_calificarEst df = new GC_calificarEst();
        df.setVisible(true);  // Se hace visible la ventana de asignación
        this.setVisible(false);       // Se oculta la ventana actual
    ...
    private void btn_atrasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_atrasActionPerformed
        askToProceed();
        GC_CrearCurso crearCurso = new GC_CrearCurso(usuarioType);
        crearCurso.setVisible(true);  // Se muestra la ventana para crear un curso
        this.setVisible(false);       // Se oculta la ventana actual
    ...
    private void btn_siguienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_siguienteActionPerformed
        askToProceed();
        GC_calificarEst df = new GC_calificarEst(usuarioType);
        df.setVisible(true);  // Se hace visible la ventana de asignación
        this.setVisible(false);       // Se oculta la ventana actual
        df.setLocationRelativeTo(null);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GC_AsignarTarea.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GC_AsignarTarea().setVisible(true);
            }
        });
    }
