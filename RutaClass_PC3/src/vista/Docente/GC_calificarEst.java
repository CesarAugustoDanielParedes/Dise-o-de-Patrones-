 ...
 */
public class GC_calificarEst extends javax.swing.JFrame {

    private UsuarioType usuarioType;

    public GC_calificarEst(UsuarioType usuarioType) {
        initComponents();
    ...
    public void askToProceed() {
        int option = JOptionPane.showConfirmDialog(null,
                "¿Deseas continuar con la calificación?", "Confirmar Calificación",
                JOptionPane.YES_NO_OPTION);

        if (option == JOptionPane.YES_OPTION) {
            // Continuar con la calificación
            JOptionPane.showMessageDialog(this, "Usuario ha decidido calificar.");
        } else {
            // Cancelar la calificación
            JOptionPane.showMessageDialog(this, "Usuario ha decidido no calificar.");
        }
    }
    ...
    private void initComponents() {
        ...
        btn_salir.setBackground(new java.awt.Color(25, 118, 210));
        ...
        jLabel14.setText("Calificar Estudiante");
    ...
    private void btn_CalificarEstActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_CalificarEstActionPerformed
        // Preguntar si desea continuar con la calificación
        askToProceed();
    }//GEN-LAST:event_btn_CalificarEstActionPerformed

    private void btn_atrasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_atrasActionPerformed
        // TODO add your handling code here:
        GC_AsignarTarea n = new GC_AsignarTarea();
        n.setVisible(true);
    ...
    private void btn_salirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_salirActionPerformed
        ...
        JOptionPane.showConfirmDialog(null,
                "¿Estás seguro de que deseas continuar?", // Mensaje
                "Confirmación", // Título
        ...
        if (JOptionPane.YES_NO_OPTION == 0) {
            Principal n = new Principal(usuarioType);
            n.setVisible(true);
            this.setVisible(false);
            n.setLocationRelativeTo(null);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GC_calificarEst.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
